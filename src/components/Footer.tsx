    ...
    <footer className="bg-primary-dark py-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <a
          ...
          className="inline-flex items-center bg-accent hover:bg-secondary transition duration-300 px-6 py-3 rounded-sm text-lg font-semibold mb-8 text-primary-dark"
        >
