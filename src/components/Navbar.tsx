  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 py-4 flex justify-between items-center backdrop-blur-xl">
        <h1 className="text-3xl font-bold text-white">Thind Car Wash</h1>
        <div className="flex space-x-4">
          <a
            ...
            className="flex items-center bg-primary-light hover:bg-primary text-accent transition duration-300 px-4 py-2 rounded-lg text-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center bg-accent hover:bg-secondary transition duration-300 px-4 py-2 rounded-lg text-sm text-primary-dark"
          >
            <svg
              viewBox="0 0 24 24"
